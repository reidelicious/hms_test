        ...
        <div class="navbar fixed-top ">
            <div class="navbar-content">
                ...
                <ul class="element-menu">
                    <li>
                    	<li><a href="<?php echo base_url()."main/makeAnnouncement"?>">Make Announcement</a></li>
                    </li>
                    <li><span class="element-divider"></span></li>
                    <li>
                        <a class="dropdown-toggle"  href="#">Manage Users</a>
                        <ul class="dropdown-menu" data-role="dropdown">
                            <li><a href="<?php echo base_url()."admin"?>">Add User</a></li>
                            <li><a href="<?php echo base_url()."main/view_user"?>">View User</a></li>   
                        </ul>
                	</li>
