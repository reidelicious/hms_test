...
$( document ).ready(function() {  
   oTable = $('#dataTables-1').dataTable( {
    "bProcessing": true,
    "bServerSide": true,
    "sAjaxSource": '<?php echo base_url('doctor/datatable_announcementDoctor'); ?>',
...
$(document).on('click','.editInfo', function(){
  var subject = $(this).parents('td').prev();  
    ...
    if(msg=="success"){
     ...
     oTable.fnDraw();
      ...
      var not = $.Notify({
          style: {background: 'red', color: 'white'},
            caption: "Delete FAIL",
              content: "Deletion of Announcement Failed. Remove first the doctors inside the clinic!!",
                timeout: 10000 // 10 seconds
         });
    }
        //alert(msg);
